...
static Usart * const Port = ((Usart  *)0x4009C000U);
...
UARTx_Handler(void)
{
	...
	//uint_fast8_t buf = Port->US_RHR & US_RHR_RXCHR_Msk;
	//uint_fast8_t buf = Port->US_RHR;
